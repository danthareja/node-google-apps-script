...
module.exports = {
  ...
  wrongCredentialsFile: 'Path did not include "OAuth 2.0 client ID" credentials. Please check that you downloaded the right JSON credentials.',
  noFileContents: 'File has no contents.',
};
